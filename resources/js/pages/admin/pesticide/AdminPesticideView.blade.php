            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex flex-row align-items-center">
                            <a href="{{ route('pesticides.create') }}" class="btn btn-success">
                            ...
                            @isset($pesticides)
                                @foreach ($pesticides as $pesticide)
                                    <tr>
                                        ...
                                        <td><img src="{{ $pesticide['image'] }}" alt="{{ $pesticide['name'] }}" width="60"
                                                height="80"></td>
                                        <td>{{ $pesticide['name'] }}</td>
                                        <td>{{ $pesticide['activeIngredient'] }}</td>
                                        <td>{{ $pesticide['description'] }}</td>
                                        <td>{{ $pesticide['price'] }}</td>
                                        <td>{{ $pesticide['dose'] }}</td>
                                        <td>{{ $pesticide['type'] }}</td>
                                        <td class="text-center">
                                            <a href="{{ route('pesticides.edit', $pesticide['id']) }}" class="btn btn-info">
