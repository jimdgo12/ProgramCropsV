...
// Se asume que los assets (CSS, JS de la plantilla) se cargan globalmente 
// a través de resources/views/app.blade.php y la configuración de Vite.
</script>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 text-center text-lg-start">
                    <h1 class="display-4 text-white animated slideInRight align text-center">
                        <slot name="title" />
                    </h1>
                </div>
                <div class="col-lg-6">
